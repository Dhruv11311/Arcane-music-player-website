...
document.addEventListener('DOMContentLoaded', function() {
    ...
    songList.querySelectorAll('li').forEach(function(song) {
...
function nextSong() {
  ...
  currentSongIndex = parseInt((currentSongIndex + 1) % songList.querySelectorAll('li').length)||0;
...
function ThrowError(){
    ...
    error.innerHTML = `<div class="column">
                        ...
                        &nbsp;&nbsp;&nbsp;<span>Error! No Song has been selected</span>
                      </div>
